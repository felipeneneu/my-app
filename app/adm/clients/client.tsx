...
import { getClients, createClient, deleteClient, type Client } from "@/lib/actions/clients";
import { ConfirmDialog } from "@/components/ConfirmDialog";
import { Mail, Phone, Building2, Trash2, Plus, ArrowLeft, User } from "lucide-react";
      ...
      <section className="px-8 py-6">
        {clients.length === 0 ? (
          <div className="flex flex-col items-center gap-3 py-16 text-center">
            ...
            <Button onClick={() => setDialogOpen(true)}><Plus size={14} /> Cadastrar primeiro cliente</Button>
          </div>
        ) : (
